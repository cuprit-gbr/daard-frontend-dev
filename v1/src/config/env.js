...
export default [
	...
	},
	{
		...
		showDevOutput: false,
		baseUrl: 'https://daard.dainst.org/',
		restBase: 'https://daard.dainst.org/daard',
		loginUrl: 'https://daard.dainst.org/o/authorize/?response_type=code&client_id=jqAODkFHbb54YDouEx7JAT16kJxelPSIeDkU2n5U&redirect_uri=%redirect_uri%&state=abc=scope=daard-api',
		tokenUrl: 'https://daard.dainst.org/o/token/',
		tokenClientId: 'jqAODkFHbb54YDouEx7JAT16kJxelPSIeDkU2n5U',
